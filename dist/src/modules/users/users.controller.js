...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Créer un utilisateur (ADMIN)' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Modifier un utilisateur (ADMIN)' }),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Désactiver un utilisateur (ADMIN)' }),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN),
